...
complete in less than a minute. The `Results` data frame contains the original and
LD-adjusted summary statistics for each processed variant.


To visualize a result [manhattan plot](https://github.com/martintnr/LDeconv/blob/main/ManhattanPlot_ToyExample.png):
...
To use LDeconv on real data, please use this [vignette](https://github.com/martintnr/LDeconv/blob/main/vignettes/Genome-wide_LDECONV.md)
